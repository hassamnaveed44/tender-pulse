    ...
    data: [
      {
        ...
        tenderId: tender1.id,
        type: "TENDER_CREATED",
        payload: { title: tender1.title, ref: tender1.referenceNumber },
      },
      {
        actorId: user1.id,
        tenderId: tender1.id,
        type: "EVIDENCE_ATTACHED",
        payload: { requirement: req1.title, document: docIso.fileName },
      },
      {
        actorId: user1.id,
        tenderId: tender1.id,
        type: "REQUIREMENT_VERIFIED",
        payload: { requirement: req1.title, verifiedBy: user1.fullName },
      },
    ],
  });
